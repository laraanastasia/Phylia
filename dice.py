...
def dice_embed(choice):
   ...
   # embed.add_field(name="┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄",value='',inline=True)
    ...
    if choice == 1:
        ...
        embed.set_image(url="https://cdn.discordapp.com/attachments/909054108235862066/1202170194550870076/imagenew-removebg-preview.png?ex=65cc7b3d&is=65ba063d&hm=75b77f9bbc7606cc52817c295e6b0a59b95e14e9fd38684b42c5dea3abe5d2fb&")
    return embed
